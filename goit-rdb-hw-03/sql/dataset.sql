-- =====================================================================
--  goit-rdb-hw-03 : датасет Теми 3 (Northwind), згенерований з CSV-архіву
--  8 таблиць. Відкрити у MySQL Workbench і виконати цілком (⚡).
--  УВАГА: перестворює схему mydb (таблиці ДЗ2 буде замінено —
--  скриншоти ДЗ2 вже збережені; за потреби відтвори goit-rdb-hw-02/sql/create_tables.sql).
-- =====================================================================
...
-- suppliers: 29 рядків
INSERT INTO suppliers (id, name, contact, address, city, postal_code, country, phone) VALUES
...
(11, 'Heli Susswaren GmbH and Co. KG', 'Petra Winkler', 'Tiergartenstrasse 5', 'Berlin', '10785', 'Germany', '(010) 9984510'),
...
(29, 'Forets derables', 'Chantal Goulet', '148 rue Chasseur', 'Ste-Hyacinthe', 'J2S 7S8', 'Canada', '(514) 555-2955');
...
-- employees: 10 рядків
INSERT INTO employees (employee_id, last_name, first_name, birthdate, photo, notes) VALUES
...
(22, 'Gustafs Knackebrod', 9, 5, '24 - 500 g pkgs.', 21),
...
(76, 'Lakkalikoori', 23, 1, '500 ml', 18),
(77, 'Original Frankfurter grune Sosse', 12, 2, '12 boxes', 13);

-- orders: 196 рядків
INSERT INTO orders (id, customer_id, employee_id, date, shipper_id) VALUES
